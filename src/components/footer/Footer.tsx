          ...
          <div className="flex flex-col justify-center gap-4 text-center md:text-right md:items-end">
            <div className="flex flex-col items-center gap-4 md:flex-row md:items-center">
              ...
              <div className="space-y-1">
                ...
                <div className="pt-2 flex flex-col gap-2 items-center md:items-end">
                  <p className="text-xs font-semibold text-primary">
                    Me siga em tempo real no:
                  </p>
                  <div className="flex items-center gap-3">
                    <Link
                      ...
                      className="group flex items-center gap-2 text-xs text-muted-foreground hover:text-[#24A1DE] transition-colors"
                      title="Telegram"
                    >
                      <svg
                        role="img"
                    ...
                    <Link
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group flex items-center gap-2 text-xs text-muted-foreground hover:text-[#25D366] transition-colors"
                      title="WhatsApp"
                    >
                      <svg
                        role="img"
